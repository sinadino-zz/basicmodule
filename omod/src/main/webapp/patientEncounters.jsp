...
<div style=" width:960px; margin-left:auto; margin-right:auto;">
	...
	<div class="row">
        ...
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="#">Patient Encounters</a></li>
        </ul>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
        	<legend>Frequently Visites Patients</legend>
            
                <table class="table table-bordered table-striped" style="font-size: 12px;"> 
            	<tr class="info" style=" font-weight:bold;">
                    <td>Name</td>
                    <td>Encounters</td>
                    <td>Last Encounter Date</td>
                </tr>
                
                <c:forEach items="${epplist}" var="patient">
                    <tr>
                	<td>${patient.patientName}</td>
                        <td>${patient.numberOfEncounters}</td>
                        <td>${patient.lastEncounterDate}</td>
                    </tr>
